...
prepare_data_for_osemosys(data_config_short_names, data_config, path_to_combined_data_sheet,
...
if osemosys_cloud:
    extract_osmosys_cloud_results_to_csv(tmp_directory, path_to_results_config)
